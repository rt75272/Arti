...
Welcome to `artifact` contributor's guide.
...
If you experience bugs or general issues with `artifact`, please have a look
...
You can help improve `artifact` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`artifact` documentation uses [Sphinx] as its main documentation compiler.
...
```{todo} If your project is hosted on GitHub, you can also mention the following tip:
   ...
   :::{tip}
      ...
      propose changes in `artifact`'s files. While this mechanism can
...
```
conda create -n artifact python=3 six virtualenv pytest pytest-cov
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/artifact.git
   cd artifact
   ```
...
5. Install [pre-commit]:
   ...
   `artifact` comes with a lot of hooks configured to automatically help the
...
[repository]: https://github.com/<USERNAME>/artifact
[issue tracker]: https://github.com/<USERNAME>/artifact/issues
